...
//                }else{
    ...
    func addTrackToPlaylist(_ button: UIButton)
    {
        ...
        if button.tintColor == UIColor.green{
            ...
            let indexToRemove = self.placeIDs.index(of: businessObjects[index].id)
            print(indexToRemove)
            ...
            print("pressed")
            let index = button.tag
            placeIDs.append(businessObjects[index].id)
...
//                })
    ...
    func addTrackToPlaylist(_ indx: Int!)
    {
        ...
        placeIDs.append(businessObjects[indx].id)
    ...
    override func viewDidLoad(){
        ...
        // Register Nibs
        self.tableView.register(UINib(nibName: "BusinessCell", bundle: Bundle.main), forCellReuseIdentifier: "placeCell")
    }
...
//        let business = businessObjects[(indexPath! as IndexPath).row]
//        self.playlist_swiped = business.id
